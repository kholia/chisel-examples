...
# https://elixir.bootlin.com/busybox/1.35.0/source/networking/nslookup.c - OK, return code works, in 23.04
# https://elixir.bootlin.com/busybox/1.30.1/source/networking/nslookup.c - buggy, no proper return code, in 22.04
RUN git clone -b busybox-slice-lunar https://github.com/kholia/chisel-releases /opt/chisel-releases \
